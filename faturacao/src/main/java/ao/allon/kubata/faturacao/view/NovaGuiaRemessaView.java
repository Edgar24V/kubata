...
public class NovaGuiaRemessaView extends BorderPane {
    ...
    private TipoDocumento tipoDocumento = TipoDocumento.GUIA_REMESSA;
    private final ObservableList<ItemFatura> itensObservable = FXCollections.observableArrayList();

    public NovaGuiaRemessaView(FaturaService faturaService, ClienteService clienteService, ProdutoService produtoService, ModalService modalService) {
    ...
    private void initialize() {
        guiaAtual.setTipoDocumento(tipoDocumento);
    ...
    public void setTipoDocumento(TipoDocumento tipoDocumento) {
        ...
        guiaAtual.setTipoDocumento(tipoDocumento);
        if (tipoDocumento == TipoDocumento.GUIA_TRANSPORTE) {
            btnSalvar.setText("Emitir Guia de Transporte");
        } else {
